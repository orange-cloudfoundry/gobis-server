...
require (
	...
	github.com/orange-cloudfoundry/gobis v1.32.0
	github.com/orange-cloudfoundry/gobis-middlewares v1.73.0
...
require (
	...
	github.com/orange-cloudfoundry/go-auth-pubtkt v1.10.0 // indirect
